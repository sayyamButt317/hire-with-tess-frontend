  ...
  {data.image_url ? (
    ...
    <AvatarFallback>{data.candidate_name?.[0] || 'C'}</AvatarFallback>
        ...
        <div className="flex flex-col gap-4 items-center justify-center">
          <Button className="w-50 bg-[#1E4B8E] hover:bg-[#1E4B8E] cursor-pointer h-[50px] text-white">
            Hire
          </Button>
          <Button className="w-50 bg-[#F55141] hover:bg-[#F55141] cursor-pointer h-[50px] text-white">
            Reject
          </Button>
        </div>
      </div>
