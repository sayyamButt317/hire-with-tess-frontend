...
export default function GenerateLink() {
    ...
    const {copied,setCopied,showShareOptions,setShowShareOptions,showQrSharedOptions,setShowQrSharedOptions} = useToggleStore();
    ...
    return (
        ...
        readOnly
        className="text-[#4A3AFF] w-full h-[65px] underline cursor-default text-ellipsis overflow-hidden truncate border border-gray-300 rounded-[14px] px-4 pr-14" // Added pr-14 for space on the right
    />
                ...
                <div className="items-center text-center flex flex-col">
                    ...
                    {data?.qr_code_base64 && (
                        <div className="w-[200px] h-[200px] bg-white flex items-center justify-center rounded-md mt-4 shadow-xl mx-auto">
                            <QRCode  className="w-[200px] h-[200px] shadow-lg p-4"   width={216}
                                height={222} value={data.qr_code_base64 ? interviewLink : ""} />
